...
public class AdminPanelController {
    ...
    public String supportController(Authentication authentication, Model model, @RequestParam(value = "page", defaultValue = "1", required = false) String pageParam,
        ...
        if (email != null) {
            ...
            long dialogs = unviewed ?
                    userSupportDialogRepository.countBySupportUnviewedMessagesGreaterThan(0) :
            ...
            List<UserSupportDialog> supportDialogs = unviewed ?
                    userSupportDialogRepository.findBySupportUnviewedMessagesGreaterThanOrderByLastMessageDateDesc(0, pageable) :
                    userSupportDialogRepository.findByOrderByLastMessageDateDesc(pageable);
    ...
    private void addSupportUnviewedAttribute(Model model) {
        model.addAttribute("support_unviewed", userSupportDialogRepository.countBySupportUnviewedMessagesGreaterThan(0));
    }
